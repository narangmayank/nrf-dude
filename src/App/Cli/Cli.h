...
#define CLI_CMD_BUF_SIZE 100        // Cli command buffer size
#define CLI_ARG_BUF_SIZE 100        // Cli argument buffer size
#define CLI_RES_BUF_SIZE 200        // Cli response buffer size
